...
// Register post thumbnail sizes
	add_theme_support( 'post-thumbnails', array( 'noticias', 'eventos', 'revista' ) );
	...
	add_image_size( $themePrefix . 'magazineList', 265 );
...
// Enqueue scripts
	...
	function vhs_enqueue_scripts(){
		...
		wp_enqueue_script( 'moment', get_template_directory_uri().'/assets/js/moment.min.js', array('jquery'), '', true);
		wp_enqueue_script( 'simpleWeather', get_template_directory_uri().'/assets/js/jquery.simpleWeather.min.js', array('jquery'), '', true);
		wp_enqueue_script( 'jquery.sticky-kit', get_template_directory_uri().'/assets/js/jquery.sticky-kit.min.js', array('jquery'), '', true);
		wp_enqueue_script( 'jquery.easy-ticker', get_template_directory_uri().'/assets/js/jquery.easy-ticker.min.js', array('jquery'), '', true);
		wp_enqueue_script( 'jquery.subscribe-better', get_template_directory_uri().'/assets/js/jquery.subscribe-better.min.js', array('jquery'), '', true);
		...
		wp_enqueue_style( 'mainStyle', get_template_directory_uri().'/assets/css/main.css' );
		wp_enqueue_style( 'responsive', get_template_directory_uri().'/assets/css/responsive.css' );
		
		wp_enqueue_style( 'animate', get_template_directory_uri().'/assets/css/animate.css' );
		wp_enqueue_style( 'ionicons.min', get_template_directory_uri().'/assets/css/ionicons.min.css' );		
		
		wp_enqueue_style( 'preset1', get_template_directory_uri().'/assets/css/preset1.css' );
	} 
