...
/*
	...
	The first post has a big thumbnail image aligned left, the others are smaller but look like the first
*/

	// Get posts of from the most popular category
	if( ! empty( $recentNews ) ){
		echo '<section class="section">';
			echo '<h1 class="section-title" ' . get_termColor( $popularTerms[$i]->term_id, 'color') . '>' . $popularTerms[$i]->name . '</h1>';
			echo '<div class="row">';
						...
						echo '<div class="post">';
							echo '<div class="entry-header">';
								echo '<div class="entry-thumbnail">';
									echo get_the_post_thumbnail( $newsPost->ID, $themePrefix . '', array(
