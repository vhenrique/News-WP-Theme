...
function cmb_sample_metaboxes( array $meta_boxes ) {
	...
	$meta_boxes['general_meta'] = array(
		...
		'pages'      => array( 'noticias', 'eventos', 'videos' ),
		'context'    => 'normal',
		'priority'   => 'high',
		'show_names' => true,
		'fields'     => array(
	...
	// Users
	$meta_boxes['user_meta'] = array(
		'id'         => $themePrefix . 'user_meta',
		...
		'fields'     => array(
			array(
				'name' => 'Inscrever na newsletter',
				'desc' => 'Marque esta caixa se deseja marcar este usuário na newsletter.',
				'id'   => $themePrefix . 'newsletter',
				'type' => 'checkbox'
			),
		)
	);
